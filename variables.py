...
def parcel_volume(parcels, year, settings):
    ...
    elif year in range(2023,2028):
        file = settings['tdm']['main_dir'] + '2023/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    elif year in range(2028,2032):
        file = settings['tdm']['main_dir'] + '2028/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    elif year in range(2032,2037):
        file = settings['tdm']['main_dir'] + '2032/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    ...
    elif year in range(2037,2042):
        file = settings['tdm']['main_dir'] + '2037/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    elif year in range(2042,2046):
        file = settings['tdm']['main_dir'] + '2042/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    elif year in range(2046,2050):
        file = settings['tdm']['main_dir'] + '2046/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    elif year in range(2050,2099):
        file = settings['tdm']['main_dir'] + '2050/6_REMM/volumepoint.dbf'
        s = wfrc_utils.dbf2df(file).set_index('parcel_id')
        svolume = s.RASTERVALU.reindex(parcels.index).fillna(0)
    else:
        file = settings['tdm']['main_dir'] + '2019/6_REMM/volumepoint.dbf'
...
def bus_stop_dist(parcels, year, settings):
    if year < 2023:
        ...
        file = settings['tdm']['main_dir'] + '2023/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2028,2032):
        file = settings['tdm']['main_dir'] + '2028/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2032,2037):
        file = settings['tdm']['main_dir'] + '2032/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2037,2042):
        file = settings['tdm']['main_dir'] + '2037/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2042,2046):
        file = settings['tdm']['main_dir'] + '2042/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    #elif year in range(2031,2035):
    #    file = settings['tdm']['main_dir'] + '2030/' + settings['tdm']['output_distance']
    #    p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2046,2050):
        file = settings['tdm']['main_dir'] + '2046/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2050,2099):
        file = settings['tdm']['main_dir'] + '2050/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
    else:
        file = settings['tdm']['main_dir'] + '2019/' + settings['tdm']['output_distance']
        p = wfrc_utils.dbf2df(file).set_index('parcel_id')
...
def fwy_exit_dist_tdm_output(parcels, year, settings):
    if year < 2023:
        ...
        file = settings['tdm']['main_dir'] + '2023/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    elif year in range(2028,2032):
        file = settings['tdm']['main_dir'] + '2028/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    elif year in range(2032,2037):
        file = settings['tdm']['main_dir'] + '2032/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    elif year in range(2037,2042):
        file = settings['tdm']['main_dir'] + '2037/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    elif year in range(2042,2046):
        file = settings['tdm']['main_dir'] + '2042/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    #elif year in range(2031,2035):
    #    file = settings['tdm']['main_dir'] + '2030/' + settings['tdm']['output_fwy']
    #    ff = wfrc_utils.dbf2df(file).set_index('parcel_id')
    elif year in range(2046,2050):
        file = settings['tdm']['main_dir'] + '2046/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    elif year in range(2050,2099):
        file = settings['tdm']['main_dir'] + '2050/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
    else:
        file = settings['tdm']['main_dir'] + '2019/' + settings['tdm']['output_fwy']
        ff = wfrc_utils.dbf2df(file)
...
@sim.column('buildings', 'distmed_42')
def distmed_42(buildings):
    return (buildings.distmed_id == 42).astype('int32')

@sim.column('buildings', 'distmed_43')
def distmed_43(buildings):
    return (buildings.distmed_id == 43).astype('int32')

@sim.column('buildings', 'distmed_44')
def distmed_44(buildings):
    return (buildings.distmed_id == 44).astype('int32')

@sim.column('buildings', 'distmed_45')
def distmed_45(buildings):
    return (buildings.distmed_id == 45).astype('int32')

@sim.column('buildings', 'distmed_46')
def distmed_46(buildings):
    return (buildings.distmed_id == 46).astype('int32')

@sim.column('buildings', 'distmed_47')
def distmed_47(buildings):
    return (buildings.distmed_id == 47).astype('int32')

@sim.column('buildings', 'distmed_48')
def distmed_48(buildings):
    return (buildings.distmed_id == 48).astype('int32')

@sim.column('buildings', 'distmed_49')
def distmed_49(buildings):
    return (buildings.distmed_id == 49).astype('int32')

@sim.column('buildings', 'distmed_50')
def distmed_50(buildings):
    return (buildings.distmed_id == 50).astype('int32')

@sim.column('buildings', 'distmed_51')
def distmed_51(buildings):
    return (buildings.distmed_id == 51).astype('int32')

@sim.column('buildings', 'distmed_52')
def distmed_52(buildings):
    return (buildings.distmed_id == 52).astype('int32')

@sim.column('buildings', 'distmed_53')
def distmed_53(buildings):
    return (buildings.distmed_id == 53).astype('int32')

@sim.column('buildings', 'distmed_54')
def distmed_54(buildings):
    return (buildings.distmed_id == 54).astype('int32')

@sim.column('buildings', 'distmed_55')
def distmed_55(buildings):
    return (buildings.distmed_id == 55).astype('int32')

@sim.column('buildings', 'distmed_56')
def distmed_56(buildings):
    return (buildings.distmed_id == 56).astype('int32')

@sim.column('buildings', 'distmed_57')
def distmed_57(buildings):
    return (buildings.distmed_id == 57).astype('int32')

@sim.column('buildings', 'distmed_58')
def distmed_58(buildings):
    return (buildings.distmed_id == 58).astype('int32')

@sim.column('buildings', 'distmed_59')
def distmed_59(buildings):
    return (buildings.distmed_id == 59).astype('int32')

@sim.column('buildings', 'distmed_60')
def distmed_60(buildings):
    return (buildings.distmed_id == 60).astype('int32')

@sim.column('buildings', 'distmed_61')
def distmed_61(buildings):
    return (buildings.distmed_id == 61).astype('int32')

@sim.column('buildings', 'distmed_62')
def distmed_62(buildings):
    return (buildings.distmed_id == 62).astype('int32')

@sim.column('buildings', 'distmed_63')
def distmed_63(buildings):
    return (buildings.distmed_id == 63).astype('int32')
...
@sim.column('buildings_for_estimation_grouped', 'distmed_42')
def distmed_42(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 42).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_43')
def distmed_43(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 43).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_44')
def distmed_44(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 44).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_45')
def distmed_45(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 45).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_46')
def distmed_46(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 46).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_47')
def distmed_47(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 47).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_48')
def distmed_48(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 48).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_49')
def distmed_49(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 49).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_50')
def distmed_50(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 50).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_51')
def distmed_51(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 51).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_52')
def distmed_52(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 52).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_53')
def distmed_53(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 53).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_54')
def distmed_54(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 54).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_55')
def distmed_55(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 55).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_56')
def distmed_56(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 56).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_57')
def distmed_57(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 57).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_58')
def distmed_58(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 58).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_59')
def distmed_59(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 59).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_60')
def distmed_60(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 60).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_61')
def distmed_61(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 61).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_62')
def distmed_62(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 62).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_63')
def distmed_63(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 63).astype('int32')

@sim.column('buildings_for_estimation_grouped', 'distmed_64')
def distmed_64(buildings_for_estimation_grouped):
    return (buildings_for_estimation_grouped.distmed_id == 64).astype('int32')
...
def logsum_hhinc4(households, travel_data):
    ...
    # td.to_csv('td.csv')
    tdprocess = td.reset_index(level = 1)
    # tdprocess.to_csv('tdprocess0.csv')
    tdprocess["attr"] =hh.reindex(tdprocess.to_zone_id).values
    # tdprocess.to_csv('tdprocess1.csv')
    tdprocess["attr1"] = tdprocess["attr"]*np.exp(tdprocess["log2"])
    # tdprocess.to_csv('tdprocess2.csv')
    logsum = tdprocess.groupby(level = 0).attr1.apply(np.sum)
    # logsum.to_frame().to_csv('logsum.csv')
    return logsum.fillna(0).astype('int')
...
def volume_two_way_zn(zones, year, settings):
    if year < 2020:
        ...
        file = settings['tdm']['main_dir'] + '2022/' + settings['tdm']['output_volume']
        z = wfrc_utils.dbf2df(file).set_index('TAZZ')
...
def commute_time_20(zones, year, settings):
    if year < 2023:
        ...
        file = settings['tdm']['main_dir'] + '2023/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    elif year in range(2028,2032):
        file = settings['tdm']['main_dir'] + '2028/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    elif year in range(2032,2037):
        file = settings['tdm']['main_dir'] + '2032/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    elif year in range(2037,2042):
        file = settings['tdm']['main_dir'] + '2037/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    elif year in range(2042,2046):
        file = settings['tdm']['main_dir'] + '2042/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    #elif year in range(2031,2035):
    #    file = settings['tdm']['main_dir'] + '2030/' + settings['tdm']['output_volume']
    #    z = wfrc_utils.dbf2df(file).set_index('TAZZ')
    elif year in range(2046,2050):
        file = settings['tdm']['main_dir'] + '2046/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    elif year in range(2050,2099):
        file = settings['tdm']['main_dir'] + '2050/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
    else:
        file = settings['tdm']['main_dir'] + '2019/6_REMM/AvgTravelTime.csv'
        z = pd.read_csv(file).set_index('TAZ')
